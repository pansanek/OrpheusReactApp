...
export const posts: Post[] = [
  {
    ...
    authorId: 1,
    content:
      "Ищу барабанщика для рок-группы! Репетиции 2 раза в неделю в центре Москвы. Пишите в личку!",
  ...
  },
  {
    ...
    authorId: 2,
    content:
      "Провели отличную джем-сессию вчера! Спасибо всем, кто пришёл. Фото в комментариях.",
    ...
    comments: [
      {
        id: 2,
        userId: 6,
        text: "Было классно! Когда следующая?",
  ...
  },
  {
    ...
    authorId: 5,
    content:
      "Новый трек в работе! Ищу вокалиста/вокалистку для записи. Жанр: электроника с элементами хип-хопа.",
  ...
  },
  {
    ...
    authorId: 3,
    content:
      "Кто-нибудь знает хорошую студию для записи барабанов в Москве? Нужна большая комната с хорошей акустикой.",
    ...
    comments: [
      {
        id: 3,
        userId: 1,
        text: "Пробовал SoundLab? У них отличная комната.",
        timestamp: "2024-12-04T14:45:00",
      },
    ],
    groupId: null,
  },
